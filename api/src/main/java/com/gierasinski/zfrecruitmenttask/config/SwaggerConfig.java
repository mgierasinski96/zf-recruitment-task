package com.gierasinski.zfrecruitmenttask.config;
...
public class SwaggerConfig implements WebMvcConfigurer {
    ...
    public Docket api() {
        Docket docket = new Docket(DocumentationType.SWAGGER_2)
                ...
                .paths(PathSelectors.any()).apis(RequestHandlerSelectors.basePackage("com.gierasinski.zfrecruitmenttask.controller"))
                .build()
